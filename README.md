...
execute deploy.sh in project under Build/Execute shell
/home/ubuntu/scripts/deploy.sh

#########
Setup webhooks and Jenkins service in GitHub to do notifications to Jenkins.
To automate builds
#########
Clone gitHub repo on local server
git clone https://github.com/jabbasi1970/JawAnagrams.git

check git status
git status

commit and add changes
git commit -a 
